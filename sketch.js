...
function telaCreditos(){
  ...
  textSize(20);
  fill(40);
  text("NÍCOLAS PEREIRA DA SILVA", 200, 100);
  textSize(15);
  text("COMPUTER PROGRAMER", 200, 120);
  textSize(13);
  text("- TÉCNICO EM ELETROMECÂNCIA PELO IFRN; \n- CURSANTE DE CIÊNCIA E TECNOLOGIA BACHARELADO PELA UFRN.", 200, 140, 300);
  image(imagemProgramador, 20, 70, 140, 140) 
